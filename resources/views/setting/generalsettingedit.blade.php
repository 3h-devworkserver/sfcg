@extends('layouts.master')
    @section('content')
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Edit General Setting</h2>
                <div class="clearfix"></div>
            </div>
            
            <div class="x_content">
                <br />
                {{Form::model($setting, ['url'=>'settings/generalsetting', 'id'=>'demo-form2', 'class'=>'form-horizontal form-label-left', 'data-parsley-validate', 'files'=> 'true', 'method'=>'PATCH'])}}
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Miscellaneous JavaScript</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
